...
class Detection(QThread):
	...
	def run(self):
		...
		# Loads Yolov4
		net = cv2.dnn.readNet("D:\\Weapon_Detection_System\\Client_Side\\weights\\yolov4.weights", 
			"D:\\Weapon_Detection_System\\Client_Side\\cfg\\yolov4.cfg")
		classes = []

		# Loads object names
		with open("D:\\Weapon_Detection_System\\Client_Side\\obj.names", "r") as f:
	...
	def save_detection(self, frame):
		cv2.imwrite("D:\\Weapon_Detection_System\\Client_Side\\saved_frame\\frame.jpg", frame)
		print('Frame Saved')
		self.post_detection()
